...
class Model(db.Model):
    ...
    info = db.relationship('Brand', backref='models')
    
    def __repr__(self):
        """Provide helpful representation when printed."""

        s = "<year=%s brand_name=%s name=%s>"
        return s % (self.year, self.brand_name, self.name)
...
class Brand(db.Model):
    ...
    def __repr__(self):
        ...
        return "<founded={} name={}>".format(self.founded, self.name)
